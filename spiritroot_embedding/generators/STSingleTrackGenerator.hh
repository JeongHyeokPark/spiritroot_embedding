...
class STSingleTrackGenerator : public FairGenerator
{
  public:
    ...
    void SetRandomPt(Bool_t f, Double_t m0, Double_t m1)
    { fRandomPt = f; fPtRange[0] = m0; fPtRange[1] = m1; }
    void SetRandomRapidity(Bool_t f, Double_t m0, Double_t m1)
    { fRandomRapidity = f; fRapRange[0] = m0; fRapRange[1] = m1; }
    void SetRandomPt(Bool_t f) { fRandomPt = f; }
