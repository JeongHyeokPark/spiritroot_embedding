...
void run_digi(TString name = "protons_75_events", double beamrate=1.973E-08, TString ParFile = "ST.parameters.par", bool simulateBeam = false)
{
  gRandom -> SetSeed(0);
  ...
  ********************************************************************************/
  ...
  //fElectronicsTask -> SetPersistence(false);
